...
ATTENTION IL FAUT CHANGER L'IMAGE QUI N'EST PLUS A JOUR
...
In case of ambiguity (i.e. not exactly one point in the first quadrant), take the right point as **P1**. \
If an ambiguity remains, see the sorting rules in the **sort_src()** in **dev/utils/GCP_detection.py** and note that the first principle of the rule is: a unique point in the first quadrant around the centroid of the polygon is always **P1**.
